    ...
    <div class="staff-content" v-loading="orderInfoLoading">
      ...
      <el-row class="expand-row">
        ...
        <el-col :span="5">
          ...
          <span class="content-text">{{orderInfo.family_people.children}}小孩，{{orderInfo.family_people.adlut}}成人，{{orderInfo.family_people.old}}老人</span>
        </el-col>
      </el-row>
      <el-row class="expand-row">
        <el-col :span="8">
